...
class PublicResource extends React.Component {
  ...
  render() {
    ...
    switch (activeKey) {
      case 'obj':
        result = <Tree onlyShow iconType="import" iconColor="#1296db" data={this.listToTree(propertyObj)} oriData={propertyObj} selectNode={this.selectNodeObj} editNode={this.editNodeObj} />
        break
      case 'data':
        result = <Tree onlyShow iconType="import" iconColor="#1afa29" data={this.listToTree(propertyData)} oriData={propertyData} selectNode={this.selectNodeData} editNode={this.editNodeData} />
        break
      default:
        result = null
        break
